...
export const defaultSalaryCalculatorSettings: SalaryCalculatorSettings = {
  country: 'JP',
  period: 'monthly',
  amount: null,
  insurance: {}
...
export const demoWallets: WalletAccount[] = [
  {
    id: 'joint',
...
export const demoRecurringIncome: ScheduleItem[] = [
  {
    id: 'ri1',
    label: 'Salary · James',
...
export const demoSubscriptions: ScheduleItem[] = [
  {
    id: 's1',
    label: 'Rent',
    every: buildScheduleEvery('Monthly · 1st', {
...
export const demoLoanEntries: LoanEntry[] = [
  {
    id: 'loan-aziz',
    ownerMemberId: 'james',
...
export const demoTrackedProducts: ProductEntry[] = [
  {
...
export const demoReceiptScans: ReceiptScan[] = []

export const emptySeed: AppSeed = {
  budgetMode: 'personal',
